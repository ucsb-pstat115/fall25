...
date: "__Due on November 10, 2025 at 11:59 pm__"
output: pdf_document
---
...
**1. Review / Warmup: Posterior Predictive Distributions**
...
c. When the variance is less than expected under the model, we say that the data is _underdispersed_.  When the variance is more than expected under the model, we say that the data is _overdispersed_.  Do you have any evidence that the data is underdispered? Overdispered?